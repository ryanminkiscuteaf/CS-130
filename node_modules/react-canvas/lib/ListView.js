...
var ListView = React.createClass({
  ...
  handleWheel: function (e) {
    ...
    this.scroller.doTouchMove([{ pageX: this._gestureStart.x + this._cumulativeScroll.x, 
                                 pageY: this._gestureStart.y + this._cumulativeScroll.y}], e.timeStamp);
    ...
    this._scrollWheelEndDebouncer = setTimeout(function () {
      self.scroller.doTouchEnd(ts);
      self._inputIdentifier = false;
